...
public class Conexao {
	...
	public void criarBanco() {
		try {
			...
			sql = "create table if not exists usuarios ( pkuser int AUTO_INCREMENT," + "nome varchar(40) not null,"
					+ "idade varchar(5) not null," + "email varchar(40) not null," + "senha varchar(20) not null,"
					+ "PRIMARY KEY ( pkuser ) ) ";
			ps = con.prepareStatement(sql);
			ps.executeUpdate(); // Executa o comando SQL dentro do servidor
